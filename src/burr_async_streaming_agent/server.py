"""FastAPI backend server side to allow streaming of the application."""
...
from burr_async_streaming_agent import app_burr as chat_application
...
def _get_application(project_id: str, app_id: str) -> Application:
    ...
    return (
        ...
        .with_tracker(tracker)  # type: ignore
...
async def chat_response(
    project_id: str, app_id: str, prompt: PromptInput
) -> StreamingResponse:
